...
routes.delete('/images/restaurants/:id/:imageId', uploadRestaurants.array('images'), ImageControllers.delete)
...
routes.delete('/images/products/:id/:imageId', uploadProducts.array('images'), ImageControllers.delete)
